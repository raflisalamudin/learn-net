...
Public Class Form1
    ...
    Dim str As String
    Sub Koneksi()
        str = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\Belajar VB.Net\UAS MOTOR VB.NET\Database1.mdb"
    ...
    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        ...
        Else
            Call Koneksi()
            Dim simpan As String = "insert into Tbmotor (kodemotor, modelmotor, warnamotor, harga) " & " values ('" & TextBox1.Text & "','" & ComboBox1.Text & "','" & ComboBox2.Text & "','" & TextBox2.Text & "')"
